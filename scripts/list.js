let headerTemplate= ` <div id="list-head">
<a href="D:\Upgrad Projects\Hotel_Booking_Website_Starter_Code\index.html"><img src = "D:\Upgrad Projects\Hotel_Booking_Website_Starter_Code\assests\images\logo.png" class="logo" /></a>
<span ><a href ="D:\Upgrad Projects\Hotel_Booking_Website_Starter_Code\login.html" target="_self" id="login"><button class="btn btn-light" data-toggle="modal" data-target="#loginModal" id="login-button" type="button" >LOGIN</button></a></span>
<!-- Modal -->
...
<div class="modal-dialog" role="document">
   ...
   <div class="modal-footer" style="justify-content: center;">
       <div><button type="login" id="primary" class="btn btn-primary">Login</button></div>
   </div>
</div>
</div>
</div>`;
...
let footerTemplate=`<div><a href="D:\Upgrad Projects\Hotel_Booking_Website_Starter_Code\contact.html" id="contact"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#submitModal" id="submit-button"style="height: 30px;padding-bottom: 30px;">Contact Us</button></a></div>
<!-- Modal -->
...
<div class="modal-footer">
    ...
    document.getElementById('footer-color').innerHTML=footerTemplate;