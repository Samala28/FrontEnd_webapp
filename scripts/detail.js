...
let footerTemplate=` <div><a href="D:\Upgrad Projects\Hotel_Booking_Website_Starter_Code\contact.html" id="contact"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#submitModal" id="submit-button">Contact Us</button></a></div>
<!-- Modal -->
